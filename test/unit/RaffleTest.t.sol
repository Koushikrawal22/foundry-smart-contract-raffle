...
contract RaffleTest is Test , CodeConstants {
      ...
      // ------------------------------  CHECK UPKEEP TESTS ---------------------------------//
       ...
       function testPerformUpKeepRevertsIfCheckUpKeepIsFalse() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Raffle.Raffle__UpKeepNeededError.selector , currentBalance , numPlayers , raffleState));
        raffleContract.performUpkeep("");
       }
       ...
       function testPerformUpKeepUpdatesRaffleStateAndEmitsEvent() public raffleEntered {
        ...
        function testFullFillRandomWordsCanOnlyBeCalledAfterPerformUpKeep(uint256 randomReqId) public raffleEntered skipFork  {
